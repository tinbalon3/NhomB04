var isUser = JSON.parse(localStorage.getItem("IsUser"))
        ...
        if(isUser.value)
        {
           ...
           var credentials = JSON.parse(localStorage.getItem("credentials"));
            ...
            document.querySelector(".slider__button").href='./Product-List-main/index_no_login.html'
            document.querySelector(".product").href ="./Product-List-main/index_no_login.html"
